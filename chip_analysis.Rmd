...
barplot(rpm9_SLC2A4,beside=TRUE,col=c("#0047AB", "#D2042D"),main="SLC2A4 H3K9ac",ylab="counts per million",xlab="participant",ylim=c(0,70))
legend(11.5,67, legend=c("Pre", "Post"), fill=c("#0047AB", "#D2042D"), cex=1)
