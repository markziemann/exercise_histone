...
lapply(1:ncol(inputs) , function(i) {
  ...
  points(-100:99*10,y,type="l",col="blue")
} )
...
plot(-100:99*10,k9pre,type="l",cex=1,ylim=c(0.3,2.5), main="H3K9ac Pre v post",
  xlab="Distance to TSS", ylab="read density",col="black")
points(-100:99*10,k9pos,type="l",col="red")

plot(-100:99*10,k36pre,type="l",cex=1,ylim=c(0.3,2.5), main="H3K36ac Pre v post",
  xlab="Distance to TSS", ylab="read density",col="black")
points(-100:99*10,k36pos,type="l",col="red")
