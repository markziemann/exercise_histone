...
barplot(rpm9_SLC2A4,beside=TRUE,col=c("#0047AB", "#D2042D"),main="SLC2A4 H3K9ac",ylab="counts per million",xlab="participant")
legend(11,67, legend=c("Pre", "Post"), fill=c("#0047AB", "#D2042D"), cex=1)
...
barplot(rpm36_SLC2A4,beside=TRUE,col=c("#0047AB", "#D2042D"),main="SLC2A4 H3K36ac",ylab="counts per million",xlab="participant")
legend(4,60, legend=c("Pre", "Post"), fill=c("#0047AB","#D2042D"), cex=1)
